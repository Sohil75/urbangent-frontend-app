...
const FormalWearPage = ({ onClicked, addToWishlist }) => {
  ...
  try {
    filteredProduct = products.filter((product) => {
      if (filter === "All") {
        return product.category === "FullWear";
      }
      console.log(products.map((product) => product.subcategory));
      return (
        product.category === "FullWear" &&
  ...
  return (
    <div className="product-section">
      <h1 className="title">FORMAL WEAR PRODUCTS</h1>
